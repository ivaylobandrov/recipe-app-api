...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_filter_ingredients(self):
        ...
        recipe_2 = create_recipe(user=self.user, title='Chicken Cacciatore')
        ingredient_1 = Ingredient.objects.create(user=self.user, name='Feta Cheese')
        ingredient_2 = Ingredient.objects.create(user=self.user, name='Chicken')
